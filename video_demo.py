...
def main(yolo):
   ...
   # deep_sort
    ...
    video_path ="C:/Users/Rashid Ali/Desktop/Person counting/V06.mp4"
    ...
    # Define the codec and create VideoWriter object
        ...
        out = cv2.VideoWriter('output_V11.mp4', fourcc, video_fps, video_size)
    ...
    while True:
       ...
       # print("box_num",len(boxs))
        ...
        for track in tracker.tracks:
            ...
            cv2.rectangle(frame, (int(bbox[0]), int(bbox[1])), (int(bbox[2]), int(bbox[3])),(255,255,255), 2)
            cv2.putText(frame, str(track_id),(int(bbox[0]), int(bbox[1])),0, 5e-3 * 100, (0,255,0),2)
        
        cv2.putText(frame, str(count1), (20, 50), 0, 5e-3 * 100 , (247, 7, 7), 2)
        cv2.putText(frame, '{:.2f}ms'.format((time.time() -t1) * 1000), (20, 20), fontFace=cv2.FONT_HERSHEY_COMPLEX, fontScale=0.5, color=(247, 7, 7), thickness=1)
